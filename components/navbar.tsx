...
const HNAYA_NAV = [
  { key: "home",    url: "https://hnaya.dz",                 labels: { ar: "هناية",       fr: "Accueil",        en: "Home"           } },
  { key: "market",  url: "https://hnaya.dz/boutique",        labels: { ar: "هناية ماركت", fr: "Hnaya Market",   en: "Hnaya Market"   } },
  { key: "tube",    url: "https://hnaya.dz/hnayatube",       labels: { ar: "هناية تيوب",  fr: "Hnaya Tube",     en: "Hnaya Tube"     } },
...
export const Navbar = () => {
  ...
  // Quand les onglets sont à droite, la navbar doit laisser 200px à droite
